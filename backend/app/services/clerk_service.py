...
def triage_student_query(
    ...
    if any(
        ...
        if any(
            ...
            k in combined for k in ["cs", "cse", "computer", "python", "java", "coding", "software"]
        ):
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                "high"
                if any(k in combined for k in ["hall ticket", "admit card", "tomorrow", "urgent"])
                else "normal"
            ),
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                "high"
                if any(k in combined for k in ["deadline", "graduation", "urgent"])
                else "normal"
            ),
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                "high"
                if any(k in combined for k in ["deadline", "late fee", "hold", "overdue", "urgent"])
                else "normal"
            ),
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                "urgent"
                if any(k in combined for k in ["visa", "passport", "urgent", "travel"])
                else "normal"
            ),
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                "high"
                if any(k in combined for k in ["locked", "exam tomorrow", "cannot login", "urgent"])
                else "normal"
            ),
    ...
    if any(
        ...
        return ClerkTriageResult(
            ...
            priority=(
                ...
                if any(
                    k in combined
                    for k in ["leak", "broken", "medical", "urgent", "bad water", "no water"]
                )
                else "normal"
            ),
